                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <?php
                        if($dataLevel == 'is_admin'){
                            ...
                            echo'<li><a href="'.site_url().'main/users">Users List</a></li>';                            
                            echo'<li><a href="'.site_url().'main/settings"><i class="glyphicon glyphicon-cog" aria-hidden="true"></i> Summons</a></li>';
                            echo'<li><a href="'.site_url().'main/users">Users List</a></li>';  
